...
final class Version20220605134158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE absences (id INT AUTO_INCREMENT NOT NULL, module_id INT DEFAULT NULL, user_id INT DEFAULT NULL, classe_id INT DEFAULT NULL, date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_by VARCHAR(255) DEFAULT NULL, du DATETIME DEFAULT NULL, au DATETIME DEFAULT NULL, INDEX IDX_F9C0EFFFAFC2B591 (module_id), INDEX IDX_F9C0EFFFA76ED395 (user_id), INDEX IDX_F9C0EFFF8F5EA509 (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
